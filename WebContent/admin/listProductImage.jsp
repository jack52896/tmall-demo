...
<div class="workingArea">
        <ol class="breadcrumb">
          ...
          <li><a href="admin_listProduct_list?category.id=${product.category.id}">${product.category.name}</a></li>
                ...
                <div class="panel panel-warning addPictureDiv">
                    <div class="panel-heading">新增产品<b class="text-primary"> 单个 </b>图片</div>
                      <div class="panel-body">
                            <form method="post" class="addFormSingle" action="admin_listProductImage_add" enctype="multipart/form-data">
                        ...
                        <c:forEach items="${productSingleImages}" var="pi">
                            <tr>
                                ...
                                <td><a deleteLink="true"
                                    href="admin_listProductImage_delete?productImage.id=${pi.id}"><span
